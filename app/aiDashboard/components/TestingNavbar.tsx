...
const TestingNavbar: React.FC<NavbarProps> = ({ user, mobileMenuOpen, setMobileMenuOpen, setUser }) => {
    ...
    return (
        <>
            ...
            <div className="w-full  h-15 px-2 border-b  border-gray-300 flex justify-between items-center">
                {!mobileMenuOpen && (
                    <div
                        className="p-2 border-b h-15 border-gray-300 flex items-center justify-center md:hidden text-gray-800"
